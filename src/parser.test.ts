...
import { parseSCNumber, parseCsv, parseTime } from './parser';
...
describe('parser', () => {
  ...
  it('parseCsv', () => {
    const objects = parseCsv(`date;time;status;reference;description;assetType;type;isin;shares;price;amount;fee;tax;currency
